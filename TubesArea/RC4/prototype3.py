...
def intercept_message(encrypted_message, fake_key):
    try:
        intercepted_message = decrypt_message(encrypted_message, fake_key)
...
if __name__ == "__main__":
    ...
    # Simulate an eavesdropper intercepting the message with a wrong key
    fake_key = b"wrong_key"
    intercept_message(encrypted_message, fake_key)
